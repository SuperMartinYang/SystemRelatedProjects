...
#define INTERRUPT_PIT_TIMER_3   0x43

#define INTERRUPT_EOI           0x20

// set IF of FLAGS, sti -> set to 1, cli -> set to 0
...
// 32 INT (interrupt), 16 IRQ (interrupt request), 1 SYSCALL_INTERRUPT 
enum {
    INT0 = 0,
	INT1,
	INT2,
...
// 49 isr (interrupt service routine OR interrupt handler), corresponding to interrupt enum
extern void isr00();
extern void isr01();
extern void isr02();
extern void isr03();
